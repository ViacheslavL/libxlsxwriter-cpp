...
int main() {
    ...
    std::shared_ptr<xlsxwriter::workbook> workbook = std::make_shared<xlsxwriter::workbook>("test_chart_bar69.xlsx");
    ...
    chart->get_x_axis()->set_name_range("Sheet1", 1, 0);
    chart->get_y_axis()->set_name_range("Sheet1", 2, 0);
