...
int main() {
    ...
    std::shared_ptr<xlsxwriter::workbook> workbook = std::make_shared<xlsxwriter::workbook>("test_chart_bar70.xlsx");
    ...
    series2->set_name("Apple");
    series3->set_name("=Sheet1!$A$7");
