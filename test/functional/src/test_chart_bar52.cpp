...
int main() {
    ...
    xlsxwriter::workbook *workbook   = new_workbook("test_chart_bar52.xlsx");
    ...
    xlsxwriter::LXW_CHART_series *series1 = chart->add_series("Sheet2!$A$1:$A$5", "Sheet2!$B$1:$B$5");
    xlsxwriter::LXW_CHART_series *series2 = chart->add_series("Sheet2!$A$1:$A$5", "Sheet2!$C$1:$C$5");
